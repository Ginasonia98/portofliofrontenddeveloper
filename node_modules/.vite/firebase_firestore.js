...
var Q2 = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(e).then((e2) => this.i !== t2 ? (C2("FirebaseAuthCredentialsProvider", "getToken aborted due to token change."), this.getToken()) : e2 ? ($(typeof e2.accessToken == "string"), new U2(e2.accessToken, this.currentUser)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
  ...
  u() {
    ...
    return $(t2 === null || typeof t2 == "string"), new b(t2);
  }
};
var z2 = class {
  constructor(t2, e, n) {
    this.h = t2, this.l = e, this.m = n, this.type = "FirstParty", this.user = b.FIRST_PARTY, this.g = new Map();
  }
  p() {
...
var H2 = class {
  ...
  getToken() {
    ...
    return this.forceRefresh = false, this.appCheck ? this.appCheck.getToken(t2).then((t3) => t3 ? ($(typeof t3.token == "string"), this.T = t3.token, new W2(t3.token)) : null) : Promise.resolve(null);
  }
  invalidateToken() {
    this.forceRefresh = true;
  }
...
function ft(t2, e) {
  ...
  for (let s = 0; s < Math.min(t2.fields.length, e.fields.length); ++s)
    if (n = wt(t2.fields[s], e.fields[s]), n !== 0)
      return n;
...
function wt(t2, e) {
  ...
  return n !== 0 ? n : X2(t2.kind, e.kind);
}
var _t = class {
  constructor(t2, e) {
...
function pt(t2, e) {
  ...
  return n !== 0 ? n : (n = ct.comparator(t2.documentKey, e.documentKey), n !== 0 ? n : X2(t2.largestBatchId, e.largestBatchId));
}
...
var vt = class {
  constructor(t2, e, n) {
    ...
    vt.S(getUA()) === 12.2 && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
  ...
  static C() {
    var t2;
    return typeof process != "undefined" && ((t2 = process.env) === null || t2 === void 0 ? void 0 : t2.k) === "YES";
  }
  static O(t2, e) {
    return t2.store(e);
  }
  ...
  async $(t2) {
    return this.db || (C2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        s2.name === "VersionError" ? n(new L2(B2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : s2.name === "InvalidStateError" ? n(new L2(B2.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new Pt(t2, s2));
  ...
  W(t2, e) {
    ...
    return new At((s, i) => {
      t2.onerror = (t3) => {
        ...
        r.isDone ? s() : r.K === null ? i2.continue() : i2.continue(r.K);
      };
    }).next(() => At.waitFor(n));
  }
  options(t2, e) {
...
function Ft(t2) {
  return typeof t2 == "number" && Number.isInteger(t2) && !Mt(t2) && t2 <= Number.MAX_SAFE_INTEGER && t2 >= Number.MIN_SAFE_INTEGER;
}
function Bt(t2) {
  let e = "";
  ...
  for (let i = 0; i < e; ) {
    ...
    switch (t2.charAt(e2 + 1)) {
      case "":
        ...
        let o;
        s.length === 0 ? o = r : (s += r, o = s, s = ""), n.push(o);
        break;
      case "":
...
var pe = class {
  constructor(t2, e, n, s, i) {
    this.key = t2, this.value = e, this.color = n != null ? n : pe.RED, this.left = s != null ? s : pe.EMPTY, this.right = i != null ? i : pe.EMPTY, this.size = this.left.size + 1 + this.right.size;
  }
  copy(t2, e, n, s, i) {
    return new pe(t2 != null ? t2 : this.key, e != null ? e : this.value, n != null ? n : this.color, s != null ? s : this.left, i != null ? i : this.right);
  }
  isEmpty() {
    return false;
  }
  ...
  static fromBase64String(t2) {
    const e = function(t3) {
      try {
        ...
        throw typeof DOMException != "undefined" && t4 instanceof DOMException ? new Re("Invalid base64 string: " + t4) : t4;
      }
    }(t2);
    return new be(e);
  }
...
function De(t2) {
  return typeof t2 == "string" ? be.fromBase64String(t2) : be.fromUint8Array(t2);
}
function Ce(t2) {
  var e, n;
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (we(n2) !== we(s))
          return false;
        for (const t4 in n2)
          if (n2.hasOwnProperty(t4) && (s[t4] === void 0 || !Be(n2[t4], s[t4])))
            return false;
        return true;
      }(t2, e);
    default:
...
function Le(t2, e) {
  return (t2.values || []).find((t3) => Be(t3, e)) !== void 0;
}
function qe(t2, e) {
  if (t2 === e)
    return 0;
...
var on = class {
  ...
  static newInvalidDocument(t2) {
    return new on(t2, 0, st.min(), st.min(), st.min(), sn.empty(), 0);
  }
  static newFoundDocument(t2, e, n, s) {
    return new on(t2, 1, e, st.min(), n, s, 0);
  }
  static newNoDocument(t2, e) {
    return new on(t2, 2, e, st.min(), st.min(), sn.empty(), 0);
  }
  static newUnknownDocument(t2, e) {
    return new on(t2, 3, e, st.min(), st.min(), sn.empty(), 2);
  }
...
var dn = class extends fn {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? e === "in" || e === "not-in" ? this.createKeyFieldInFilter(t2, e, n) : new An(t2, e, n) : e === "array-contains" ? new Pn(t2, n) : e === "in" ? new Vn(t2, n) : e === "not-in" ? new Sn(t2, n) : e === "array-contains-any" ? new Dn(t2, n) : new dn(t2, e, n);
  }
  static createKeyFieldInFilter(t2, e, n) {
    return e === "in" ? new Rn(t2, n) : new vn(t2, n);
  }
  matches(t2) {
    const e = t2.data.field(this.field);
    return this.op === "!=" ? e !== null && this.matchesComparison(qe(e, this.value)) : e !== null && Fe(this.value) === Fe(e) && this.matchesComparison(qe(e, this.value));
  }
...
var wn = class extends fn {
  ...
  matches(t2) {
    return _n(this) ? this.filters.find((e) => !e.matches(t2)) === void 0 : this.filters.find((e) => e.matches(t2)) !== void 0;
  }
  getFlattenedFilters() {
...
var Vn = class extends dn {
  ...
  matches(t2) {
    const e = t2.data.field(this.field);
    return e !== null && Le(this.value.arrayValue, e);
  }
};
...
function Nn(t2) {
  ...
  if (e.ft === null) {
    ...
    e.collectionGroup !== null && (t3 += "|cg:" + e.collectionGroup), t3 += "|f:", t3 += e.filters.map((t4) => pn(t4)).join(","), t3 += "|ob:", t3 += e.orderBy.map((t4) => function(t5) {
...
function Zn(t2) {
  return `Query(target=${function(t3) {
    ...
    return t3.collectionGroup !== null && (e += " collectionGroup=" + t3.collectionGroup), t3.filters.length > 0 && (e += `, filters: [${t3.filters.map((t4) => En(t4)).join(", ")}]`), $t(t3.limit) || (e += ", limit: " + t3.limit), t3.orderBy.length > 0 && (e += `, orderBy: [${t3.orderBy.map((t4) => function(t5) {
      return `${t5.field.canonicalString()} (${t5.dir})`;
...
function ns(t2, e, n) {
  const s = t2.field.isKeyField() ? ct.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return s2 !== null && i !== null ? qe(s2, i) : O2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function Ls(t2, e, n, s) {
  return t2 instanceof Ks ? function(t3, e2, n2, s2) {
    ...
    if (r.setAll(Qs(t3)), r.setAll(i), e2.convertToFoundDocument(e2.version, r).setHasLocalMutations(), n2 === null)
      return null;
...
function qs(t2, e) {
  ...
  for (const s of t2.fieldTransforms) {
    ...
    i != null && (n === null && (n = sn.empty()), n.set(s.field, i));
  }
  return n || null;
}
function Us(t2, e) {
  return t2.type === e.type && (!!t2.key.isEqual(e.key) && (!!t2.precondition.isEqual(e.precondition) && (!!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && tt(t3, e2, (t4, e3) => Ns(t4, e3));
...
var _i = class {
  constructor(t2) {
    this.Ft = t2, this.Bt = new Map(), this.Lt = rs(), this.qt = mi(), this.Ut = new Ie(X2);
  }
  Kt(t2) {
  ...
  Jt(t2) {
    ...
    if (i) {
      ...
      if (On(r))
        ...
        const i2 = this.Zt(n);
        i2 !== s && (this.Ht(n), this.Ut = this.Ut.add(n), (e = ui.instance) === null || e === void 0 || e.notifyOnExistenceFilterMismatch({
          localCacheCount: i2,
    ...
    this.Bt.forEach((n2, s2) => {
      ...
      if (i) {
        if (n2.current && On(i.target)) {
          ...
          this.Lt.get(e2) !== null || this.te(s2, e2) || this.Qt(s2, e2, on.newNoDocument(e2, t2));
        }
...
function Mi(t2, e) {
  ...
  if ("targetChange" in e) {
    ...
    const s = function(t3) {
      ...
      return t3.useProto3Json ? ($(e2 === void 0 || typeof e2 == "string"), be.fromBase64String(e2 || "")) : ($(e2 === void 0 || e2 instanceof Uint8Array), be.fromUint8Array(e2 || new Uint8Array()));
    }(t2, e.targetChange.resumeToken), o = e.targetChange.cause, u = o && function(t3) {
      const e2 = t3.code === void 0 ? B2.UNKNOWN : oi(t3.code);
...
function Bi(t2, e) {
  const n = e.currentDocument ? function(t3) {
    return t3.updateTime !== void 0 ? Os.updateTime(vi(t3.updateTime)) : t3.exists !== void 0 ? Os.exists(t3.exists) : Os.none();
  }(e.currentDocument) : Os.none(), s = e.updateTransforms ? e.updateTransforms.map((e2) => function(t3, e3) {
    let n2 = null;
    if ("setToServerValue" in e3)
      $(e3.setToServerValue === "REQUEST_TIME"), n2 = new Rs();
...
function Li(t2, e) {
  return t2 && t2.length > 0 ? ($(e !== void 0), t2.map((t3) => function(t4, e2) {
...
function Ui(t2, e) {
  ...
  e.collectionGroup !== null ? (n.parent = Di(t2, s), n.structuredQuery.from = [{
...
function Ki(t2) {
  ...
  n.orderBy && (o = n.orderBy.map((t3) => function(t4) {
    return new hn(Ji(t4.field), function(t5) {
      switch (t5) {
        case "ASCENDING":
          return "asc";
        case "DESCENDING":
  ...
  n.limit && (u = function(t3) {
    let e2;
    return e2 = typeof t3 == "object" ? t3.value : t3, $t(e2) ? null : e2;
  }(n.limit));
  let c = null;
...
function cr(t2) {
  const e = or(t2.readTime), n = t2.lastLimboFreeSnapshotVersion !== void 0 ? or(t2.lastLimboFreeSnapshotVersion) : st.min();
  let s;
  var i;
  return t2.query.documents !== void 0 ? ($((i = t2.query).documents.length === 1), s = jn(qn(Ci(i.documents[0])))) : s = function(t3) {
    return jn(Ki(t3));
...
function hr(t2) {
  ...
  return t2.limitType === "LAST" ? Hn(e, e.limit, "L") : e;
}
function lr(t2, e) {
...
var gr = class {
  ...
  getOverlaysForCollection(t2, e, n) {
    const s = as(), i = Bt(e), r = IDBKeyRange.bound([this.userId, i, n], [this.userId, i, Number.POSITIVE_INFINITY], true);
...
var pr = class {
  ...
  ue(t2, e) {
    if ("nullValue" in t2)
      ...
      this.ae(e, 20), typeof n == "string" ? e.le(n) : (e.le(`${n.seconds || ""}`), e.he(n.nanos || 0));
...
var Er = class {
  ...
  Te(t2) {
    const e = 255 & t2;
    e === 0 ? (this.Ne(0), this.Ne(255)) : e === 255 ? (this.Ne(255), this.Ne(0)) : this.Ne(e);
  }
  Re(t2) {
    const e = 255 & t2;
    e === 0 ? (this.Oe(0), this.Oe(255)) : e === 255 ? (this.Oe(255), this.Oe(0)) : this.Oe(t2);
  }
  Ee() {
    this.Ne(0), this.Ne(1);
  }
...
function Pr(t2, e) {
  ...
  return n !== 0 ? n : (n = Vr(t2.arrayValue, e.arrayValue), n !== 0 ? n : (n = Vr(t2.directionalValue, e.directionalValue), n !== 0 ? n : ct.comparator(t2.documentKey, e.documentKey)));
}
function Vr(t2, e) {
...
var Sr = class {
  constructor(t2) {
    this.collectionId = t2.collectionGroup != null ? t2.collectionGroup : t2.path.lastSegment(), this.Ue = t2.orderBy, this.Ke = [];
    for (const e of t2.filters) {
      const t3 = e;
...
function Dr(t2) {
  ...
  if ($(t2 instanceof dn || t2 instanceof wn), t2 instanceof dn) {
    if (t2 instanceof Vn) {
      const s2 = ((n = (e = t2.value.arrayValue) === null || e === void 0 ? void 0 : e.values) === null || n === void 0 ? void 0 : n.map((e2) => dn.create(t2.field, "==", e2))) || [];
...
function Fr(t2) {
  ...
  }), s.length === 1 ? s[0] : wn.create(s, t2.op);
}
var Br = class {
  constructor() {
    this.He = new Lr();
...
var Ur = class {
        ...
        return At.forEach(i, (i2, r) => {
          ...
          const u = function(t4, e2) {
            ...
            for (const i3 of lt(e2)) {
              const e3 = i3.kind === 0 ? Mn(t4, i3.fieldPath, t4.startAt) : Fn(t4, i3.fieldPath, t4.startAt);
            ...
            let s3 = true;
            for (const i3 of lt(e2)) {
              const e3 = i3.kind === 0 ? Fn(t4, i3.fieldPath, t4.endAt) : Mn(t4, i3.fieldPath, t4.endAt);
              n2.push(e3.value), s3 && (s3 = e3.inclusive);
            }
            return new un(n2, s3);
  ...
  nn(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.sn(e[h / c]) : qr, l2 = this.rn(t2, u2, n[h % c], s), f = this.on(t2, u2, i[h % c], r), d = o.map((e2) => this.rn(t2, u2, e2, true));
  ...
  Xe(t2, e) {
    const n = new Sr(e), s = e.collectionGroup != null ? e.collectionGroup : e.path.lastSegment();
  ...
  getIndexType(t2, e) {
    ...
    return At.forEach(s, (e2) => this.Xe(t2, e2).next((t3) => {
      ...
      return t3.limit !== null;
    }(e) && s.length > 1 && n === 2 ? 1 : n);
  }
  un(t2, e) {
    const n = new vr();
  ...
  an(t2, e) {
    return !!t2.filters.find((t3) => t3 instanceof dn && t3.field.isEqual(e) && (t3.op === "in" || t3.op === "not-in"));
  }
  getFieldIndexes(t2, e) {
  ...
  createRange(t2, e, n) {
    n = n.sort((t3, e2) => Pr(t3, e2)).filter((t3, e2, n2) => !e2 || Pr(t3, n2[e2 - 1]) !== 0);
    const s = [];
    s.push(t2);
    for (const i2 of n) {
...
var io = class {
  ...
  Pn(t2) {
    return oo(t2).get("targetGlobalKey").next((t3) => ($(t3 !== null), t3));
  }
  Vn(t2, e) {
  ...
  removeMatchingKeysForTargetId(t2, e) {
    const n = uo(t2), s = IDBKeyRange.bound([e], [e + 1], false, true);
    return n.delete(s);
  }
  getMatchingKeysForTargetId(t2, e) {
    const n = IDBKeyRange.bound([e], [e + 1], false, true), s = uo(t2);
    let i = ws();
    return s.Z({
      range: n,
      Y: true
  ...
  containsKey(t2, e) {
    const n = Bt(e.path), s = IDBKeyRange.bound([n], [et(n)], false, true);
    let i = 0;
    return uo(t2).Z({
...
var ho = class {
  ...
  start() {
    this.garbageCollector.params.cacheSizeCollectionThreshold !== -1 && this.$n(6e4);
  }
  stop() {
...
var fo = class {
  ...
  Un(t2, e) {
    ...
    return n.Z({
      ...
      t3 === 0 ? (i !== Ot.ct && e(new ct(Ut(s)), i), i = o, s = r) : i = Ot.ct;
    }).next(() => {
...
function wo(t2, e) {
  return uo(t2).put(function(t3, e2) {
    return {
      targetId: 0,
      path: Bt(t3.path),
      sequenceNumber: e2
...
var mo = class {
  ...
  removeEntry(t2, e, n) {
    return Io(t2).delete(function(t3, e2) {
...
var vo = class {
  ...
  getDocument(t2, e) {
    let n = null;
    return this.documentOverlayCache.getOverlay(t2, e).next((s) => (n = s, this.remoteDocumentCache.getEntry(t2, e))).next((t3) => (n !== null && Ls(n.mutation, t3, Ae.empty(), nt.now()), t3));
  }
  getDocuments(t2, e) {
  ...
  computeViews(t2, e, n, s) {
    ...
    return e.forEach((t3, e2) => {
      ...
      s.has(e2.key) && (o2 === void 0 || o2.mutation instanceof Gs) ? i = i.insert(e2.key, e2) : o2 !== void 0 ? (r.set(e2.key, o2.mutation.getFieldMask()), Ls(o2.mutation, e2, o2.mutation.getFieldMask(), nt.now())) : r.set(e2.key, Ae.empty());
    }), this.recalculateAndSaveOverlays(t2, i).next((t3) => (t3.forEach((t4, e2) => r.set(t4, e2)), e.forEach((t4, e2) => {
      var n2;
      return o.set(t4, new Ro(e2, (n2 = r.get(t4)) !== null && n2 !== void 0 ? n2 : null));
    }), o));
  }
  ...
  getDocumentsMatchingCollectionGroupQuery(t2, e, n) {
    ...
    return this.indexManager.getCollectionParents(t2, s).next((r) => At.forEach(r, (r2) => {
      const o = function(t3, e2) {
        return new Bn(e2, null, t3.explicitOrderBy.slice(), t3.filters.slice(), t3.limit, t3.limitType, t3.startAt, t3.endAt);
      }(e, r2.child(s));
  ...
  getDocumentsMatchingCollectionQuery(t2, e, n) {
    ...
    return this.documentOverlayCache.getOverlaysForCollection(t2, e.path, n.largestBatchId).next((i) => (s = i, this.remoteDocumentCache.getDocumentsMatchingQuery(t2, e, n, s))).next((t3) => {
      s.forEach((e2, n3) => {
        const s2 = n3.getKey();
        t3.get(s2) === null && (t3 = t3.insert(s2, on.newInvalidDocument(s2)));
      });
      let n2 = us();
      return t3.forEach((t4, i) => {
        const r = s.get(t4);
        r !== void 0 && Ls(r.mutation, i, Ae.empty(), nt.now()), Xn(e, i) && (n2 = n2.insert(t4, i));
      }), n2;
    });
  }
};
var bo = class {
  constructor(t2) {
    this.serializer = t2, this.Zn = new Map(), this.Xn = new Map();
  }
  getBundleMetadata(t2, e) {
...
var Po = class {
  ...
  removeOverlaysForBatchId(t2, e, n) {
    ...
    return s !== void 0 && (s.forEach((t3) => this.overlays = this.overlays.remove(t3)), this.ts.delete(n)), At.resolve();
  }
  getOverlaysForCollection(t2, e, n) {
  ...
  getOverlaysForCollectionGroup(t2, e, n, s) {
    ...
    for (; r.hasNext(); ) {
      ...
      if (t3.getKey().getCollectionGroup() === e && t3.largestBatchId > n) {
        ...
        e2 === null && (e2 = as(), i = i.insert(t3.largestBatchId, e2)), e2.set(t3.getKey(), t3);
      }
    }
  ...
  re(t2, e, n) {
    ...
    let i = this.ts.get(e);
    i === void 0 && (i = ws(), this.ts.set(e, i)), this.ts.set(e, i.add(n.key));
  }
};
var Vo = class {
  constructor() {
...
var Do = class {
  ...
  removeMutationBatch(t2, e) {
    $(this.Is(e.batchId, "removed") === 0), this.mutationQueue.shift();
    let n = this._s;
...
var No = class {
  ...
  removeTargets(t2, e, n) {
    ...
    return this.As.forEach((r, o) => {
      o.sequenceNumber <= e && n.get(o.targetId) === null && (this.As.delete(r), i.push(this.removeMatchingKeysForTargetId(t2, o.targetId)), s++);
    }), At.waitFor(i).next(() => s);
  }
  getTargetCount(t2) {
...
var Lo = class {
  ...
  async gi() {
    if (this.isPrimary && !this.yi(this.ei, 18e5)) {
      ...
      const t2 = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t3) => {
        ...
        return e.j().next((t4) => {
          const n = this.pi(t4, 18e5), s = t4.filter((t5) => n.indexOf(t5) === -1);
  ...
  _i(t2) {
    ...
    return qo(t2).get("owner").next((e) => {
      if (e !== null && this.yi(e.leaseTimestampMs, 5e3) && !this.Ti(e.ownerId)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || Uo(t2).j().next((t3) => this.pi(t3, 5e3).find((t4) => {
  ...
  runTransaction(t2, e, n) {
    ...
    const s = e === "readonly" ? "readonly" : "readwrite", i = (r = this.Ys) === 15 ? le : r === 14 ? he : r === 13 ? ae : r === 12 ? ce : r === 11 ? ue : void O2();
    var r;
    let o;
    return this.ii.runTransaction(t2, s, i, (s2) => (o = new fe(s2, this.Vs ? this.Vs.next() : Ot.ct), e === "readwrite-primary" ? this.li(o).next((t3) => !!t3 || this.fi(o)).next((e2) => {
      if (!e2)
  ...
  Pi(t2) {
    return qo(t2).get("owner").next((t3) => {
      if (t3 !== null && this.yi(t3.leaseTimestampMs, 5e3) && !this.Ti(t3.ownerId) && !this._i(t3) && !(this.Js || this.allowTabSynchronization && t3.allowTabSynchronization))
        throw new L2(B2.FAILED_PRECONDITION, Bo);
    });
  }
  wi(t2) {
  ...
  ui() {
    this.document !== null && typeof this.document.addEventListener == "function" && (this.Xs = () => {
      this.Ws.enqueueAndForget(() => (this.inForeground = this.document.visibilityState === "visible", this.oi()));
    }, this.document.addEventListener("visibilitychange", this.Xs), this.inForeground = this.document.visibilityState === "visible");
  }
  Ai() {
  ...
  Ti(t2) {
    var e;
    try {
      const n = ((e = this.ri) === null || e === void 0 ? void 0 : e.getItem(this.Ii(t2))) !== null;
...
var Qo = class {
  ...
  Ni(t2, e) {
    if (Un(e))
      return At.resolve(null);
    let n = jn(e);
    return this.indexManager.getIndexType(t2, n).next((s) => s === 0 ? null : (e.limit !== null && s === 1 && (e = Hn(e, null, "F"), n = jn(e)), this.indexManager.getDocumentsMatchingTarget(t2, n).next((s2) => {
      const i = ws(...s2);
...
var zo = class {
  constructor(t2, e, n, s) {
    this.persistence = t2, this.Bi = e, this.serializer = s, this.Li = new ge(X2), this.qi = new ss((t3) => Nn(t3), kn), this.Ui = new Map(), this.Ki = t2.getRemoteDocumentCache(), this.Ds = t2.getTargetCache(), this.xs = t2.getBundleCache(), this.Gi(n);
  }
  Gi(t2) {
    ...
    return function(t4, e2, n2, s2) {
      ...
      return r.forEach((t5) => {
        o = o.next(() => s2.getEntry(e2, t5)).next((e3) => {
          ...
          $(r2 !== null), e3.version.compareTo(r2) < 0 && (i2.applyToRemoteDocument(e3, n2), e3.isValidDocument() && (e3.setReadTime(n2.commitVersion), s2.addEntry(e3)));
        });
...
function tu(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (t3) => {
    ...
    return (s === null || t3.snapshotVersion.compareTo(s.snapshotVersion) > 0) && (n.Li = n.Li.insert(t3.targetId, t3), n.qi.set(e, t3.targetId)), t3;
  });
}
...
function nu(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    ...
    return i2 !== void 0 ? At.resolve(s2.Li.get(i2)) : s2.Ds.getTargetData(e2, n2);
  }(s, t3, jn(e)).next((e2) => {
    if (e2)
...
function iu(t2, e) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (t3) => n.Ki.getAllFromCollectionGroup(t3, e, mt(s, -1), Number.MAX_SAFE_INTEGER)).then((t3) => (ru(n, e, t3), t3));
}
function ru(t2, e, n) {
...
var lu = class {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = typeof s.error.message == "string" && typeof s.error.code == "string", r && (i = new L2(s.error.code, s.error.message))), r ? new lu(t2, e, s.state, i) : (x2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  Xi() {
    const t2 = {
      state: this.state,
...
var fu = class {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = typeof n.error.message == "string" && typeof n.error.code == "string", i && (s = new L2(n.error.code, n.error.message))), i ? new fu(t2, n.state, s) : (x2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  Xi() {
    const t2 = {
      state: this.state,
...
var du = class {
  ...
  static Zi(t2, e) {
    const n = JSON.parse(e);
    let s = typeof n == "object" && n.activeTargetIds instanceof Array, i = ms();
...
var wu = class {
  ...
  static Zi(t2) {
    ...
    return typeof e == "object" && ["Unknown", "Online", "Offline"].indexOf(e.onlineState) !== -1 && typeof e.clientId == "string" ? new wu(e.clientId, e.onlineState) : (x2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var _u = class {
  constructor() {
...
var mu = class {
  ...
  Sr(t2, e) {
    const n = this.lr.exec(t2), s = Number(n[1]), i = n[2] !== void 0 ? n[2] : null;
...
var Iu = null;
function Tu() {
  return Iu === null ? Iu = 268435456 + Math.round(2147483648 * Math.random()) : Iu++, "0x" + Iu.toString(16);
}
var Eu = {
  ...
  wo(t2, e, n) {
    ...
    return d(a, WebChannel.EventType.OPEN, () => {
      ...
      if (!l2) {
        const i2 = e2.data[0];
        $(!!i2);
        const r2 = i2, o2 = r2.error || ((n2 = r2[0]) === null || n2 === void 0 ? void 0 : n2.error);
        if (o2) {
          ...
          n3 === void 0 && (n3 = B2.INTERNAL, i3 = "Unknown error status: " + e3 + " with message " + o2.message), l2 = true, f.so(new L2(n3, i3)), a.close();
        } else
...
var Du = class {
  ...
  async close(t2, e) {
    this.Bo(), this.Lo(), this.Co.cancel(), this.Vo++, t2 !== 4 ? this.Co.reset() : e && e.code === B2.RESOURCE_EXHAUSTED ? (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.Co.Eo()) : e && e.code === B2.UNAUTHENTICATED && this.state !== 3 && (this.authCredentialsProvider.invalidateToken(), this.appCheckCredentialsProvider.invalidateToken()), this.stream !== null && (this.qo(), this.stream.close(), this.stream = null), this.state = t2, await this.listener.Zr(e);
  }
  qo() {
  }
  auth() {
...
var xu = class extends Du {
  ...
  onMessage(t2) {
    ...
    return $(!t2.writeResults || t2.writeResults.length === 0), this.Ho = true, this.listener.Xo();
  }
  tu() {
    const t2 = {};
...
async function ku(t2, e, n) {
  ...
  return $(o.length === 1), (u = o[0]).result, u.result.aggregateFields, new sn({
    mapValue: {
      fields: (c = u.result) === null || c === void 0 ? void 0 : c.aggregateFields
    }
  });
  var u, c;
}
var Ou = class {
  ...
  au(t2) {
    this.state === "Online" ? this.uu("Unknown") : (this.su++, this.su >= 1 && (this.hu(), this.cu(`Connection failed 1 times. Most recent error: ${t2.toString()}`), this.uu("Offline")));
  }
  set(t2) {
    this.hu(), this.su = 0, t2 === "Online" && (this.ru = false), this.uu(t2);
  }
  uu(t2) {
...
var $u = class {
  constructor(t2, e, n, s, i) {
    this.localStore = t2, this.datastore = e, this.asyncQueue = n, this.remoteSyncer = {}, this.lu = [], this.fu = new Map(), this.du = new Set(), this.wu = [], this._u = i, this._u.qr((t3) => {
...
function Lu(t2, e) {
  ...
  n.fu.delete(e), s.No() && Uu(n, e), n.fu.size === 0 && (s.No() ? s.$o() : Qu(n) && n.mu.set("Unknown"));
}
function qu(t2, e) {
...
async function Hu(t2, e, n) {
  if (t2.mu.set("Online"), e instanceof di && e.state === 2 && e.cause)
    try {
...
var wc2 = class {
  ...
  track(t2) {
    ...
    n ? t2.type !== 0 && n.type === 3 ? this.Iu = this.Iu.insert(e, t2) : t2.type === 3 && n.type !== 1 ? this.Iu = this.Iu.insert(e, {
      type: n.type,
      doc: t2.doc
    }) : t2.type === 2 && n.type === 2 ? this.Iu = this.Iu.insert(e, {
      type: 2,
      doc: t2.doc
    }) : t2.type === 2 && n.type === 0 ? this.Iu = this.Iu.insert(e, {
      type: 0,
      doc: t2.doc
    }) : t2.type === 1 && n.type === 0 ? this.Iu = this.Iu.remove(e) : t2.type === 1 && n.type === 2 ? this.Iu = this.Iu.insert(e, {
      type: 1,
      doc: n.doc
    }) : t2.type === 0 && n.type === 1 ? this.Iu = this.Iu.insert(e, {
      type: 2,
      doc: t2.doc
...
var _c = class {
  ...
  static fromInitialDocuments(t2, e, n, s, i) {
    ...
    }), new _c(t2, e, dc2.emptySet(e), r, n, s, true, false, i);
  }
  get hasPendingWrites() {
...
var gc2 = class {
  constructor() {
    this.queries = new ss((t2) => Yn(t2), Jn), this.onlineState = "Unknown", this.Au = new Set();
  }
};
...
var Ac2 = class {
  ...
  vu(t2) {
    if (!this.options.includeMetadataChanges) {
      ...
      for (const n of t2.docChanges)
        n.type !== 3 && e2.push(n);
      t2 = new _c(t2.query, t2.docs, t2.oldDocs, e2, t2.mutatedKeys, t2.fromCache, t2.syncStateChanged, true, t2.hasCachedResults);
    }
    let e = false;
  ...
  Du(t2, e) {
    if (!t2.fromCache)
      return true;
    const n = e !== "Offline";
    return (!this.options.xu || !n) && (!t2.docs.isEmpty() || t2.hasCachedResults || e === "Offline");
  }
  Su(t2) {
...
var bc2 = class {
  constructor(t2, e, n) {
    this.Ou = t2, this.localStore = e, this.serializer = n, this.queries = [], this.documents = [], this.collectionGroups = new Set(), this.progress = Pc2(t2);
  }
  $u(t2) {
  ...
  Mu(t2) {
    const e = new Map(), n = new vc2(this.serializer);
    for (const s of t2)
...
var Dc2 = class {
  ...
  applyChanges(t2, e, n) {
    ...
    const r = e ? this.Ju() : [], o = this.Uu.size === 0 && this.current ? 1 : 0, u = o !== this.qu;
    if (this.qu = o, i.length !== 0 || u) {
      return {
        snapshot: new _c(this.query, t2.Gu, s, i, t2.mutatedKeys, o === 0, u, false, !!n && n.resumeToken.approximateByteSize() > 0),
        Yu: r
      };
    }
    return {
  ...
  tc() {
    return _c.fromInitialDocuments(this.query, this.Gu, this.mutatedKeys, this.qu === 0, this.hasCachedResults);
  }
};
var Cc2 = class {
  constructor(t2, e, n) {
...
async function Oc2(t2, e, n, s, i) {
  t2.dc = (e2, n2, s2) => async function(t3, e3, n3, s3) {
    ...
    i2.Mi && (i2 = await nu(t3.localStore, e3.query, false).then(({ documents: t4 }) => e3.view.zu(t4, i2)));
  ...
  const r = await nu(t2.localStore, e, true), o = new Dc2(e, r.Wi), u = o.zu(r.documents), c = hi.createSynthesizedTargetChangeForCurrentChange(n, s && t2.onlineState !== "Offline", i), a = o.applyChanges(u, t2.isPrimaryClient, c);
  Wc2(t2, n, a.Yu);
...
async function $c2(t2, e) {
  ...
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await eu(n.localStore, s.targetId, false).then(() => {
      n.sharedClientState.clearQueryState(s.targetId), Lu(n.remoteStore, s.targetId), zc2(n, s.targetId);
    }).catch(Et);
  } else
    zc2(n, s.targetId), await eu(n.localStore, s.targetId, true);
}
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (t5) => {
        ...
        return n2.Ki.getEntries(t5, i).next((t6) => {
          ...
          for (const t6 of e2) {
            ...
            e3 != null && o2.push(new Gs(t6.key, e3, rn(e3.value.mapValue), Os.exists(true)));
          }
...
async function Lc2(t2, e, n) {
  ...
  if (r) {
    ...
    const n2 = ws().add(r), i2 = new ai(st.min(), new Map(), new Ie(X2), t3, n2);
    await Fc2(s, i2), s.oc = s.oc.remove(r), s.uc.delete(e), Jc2(s);
  } else
    await eu(s.localStore, e, false).then(() => zc2(s, e, n)).catch(Et);
}
...
function jc2(t2, e) {
  ...
  const n = t2.oc.get(e);
  n !== null && (Lu(t2.remoteStore, n), t2.oc = t2.oc.remove(e), t2.uc.delete(n), Jc2(t2));
}
function Wc2(t2, e, n) {
  for (const s of n)
    if (s instanceof Vc2)
...
async function ta2(t2, e) {
  const n = F(t2), s = await nu(n.localStore, e.query, true), i = e.view.Xu(s);
...
async function na2(t2, e, n, s) {
  ...
  r !== null ? (n === "pending" ? await Zu(i.remoteStore) : n === "acknowledged" || n === "rejected" ? (Qc2(i, e, s || null), Gc2(i, e), function(t3, e2) {
...
async function sa2(t2, e) {
  const n = F(t2);
  if (aa2(n), ha2(n), e === true && n.fc !== true) {
    ...
    n.ic.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (zc2(n, i), eu(n.localStore, i, true))), Lu(n.remoteStore, i);
    }), await e2, await ia2(n, t3), function(t4) {
      const e3 = F(t4);
      e3.uc.forEach((t5, n2) => {
        Lu(e3.remoteStore, n2);
      }), e3.cc.ls(), e3.uc = new Map(), e3.oc = new ge(ct.comparator);
...
async function ia2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && n2.length !== 0) {
      ...
      e2 = await tu(s.localStore, n3), await Oc2(s, ra2(n3), t3, false, e2.resumeToken);
    }
    i.push(e2);
  }
  return s.nc.zo(r), i;
...
async function ua2(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await iu(i.localStore, ts(r[0])), s2 = ai.createSynthesizedRemoteEventForCurrentChange(e, n === "current", be.EMPTY_BYTE_STRING);
        await Yc2(i, t3, s2);
        break;
      }
      case "rejected":
        await eu(i.localStore, e, true), zc2(i, e, s);
        break;
      default:
        O2();
    }
...
async function ca2(t2, e, n) {
  ...
  if (s.fc) {
    for (const t3 of e) {
      ...
      await Oc2(s, ra2(e2), n2.targetId, false, n2.resumeToken), Bu(s.remoteStore, n2);
    }
    for (const t3 of n)
      s.ic.has(t3) && await eu(s.localStore, t3, false).then(() => {
...
function la2(t2, e, n) {
  ...
  (async function(t3, e2, n2) {
    try {
      ...
      return await Yc2(t3, o.Bu, void 0), await function(t4, e3) {
        const n3 = F(t4);
...
var da2 = class extends fa2 {
  ...
  createPersistence(t2) {
    const e = Ko(t2.databaseInfo.databaseId, t2.databaseInfo.persistenceKey), n = this.cacheSizeBytes !== void 0 ? Hr.withCacheSize(this.cacheSizeBytes) : Hr.DEFAULT;
...
var _a = class {
  async initialize(t2, e) {
    this.localStore || (this.localStore = t2.localStore, this.sharedClientState = t2.sharedClientState, this.datastore = this.createDatastore(e), this.remoteStore = this.createRemoteStore(e), this.eventManager = this.createEventManager(e), this.syncEngine = this.createSyncEngine(e, !t2.synchronizeTabs), this.sharedClientState.onlineStateHandler = (t3) => Bc2(this.syncEngine, t3, 1), this.remoteStore.remoteSyncer.handleCredentialChange = Zc2.bind(null, this.syncEngine), await cc2(this.remoteStore, this.syncEngine.isPrimaryClient));
  }
  ...
  constructor(t2, e) {
    this.Ic = t2, this.serializer = e, this.metadata = new q2(), this.buffer = new Uint8Array(), this.Tc = new TextDecoder("utf-8"), this.Ec().then((t3) => {
      t3 && t3.ku() ? this.metadata.resolve(t3.Nu.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(t3 == null ? void 0 : t3.Nu)}`));
...
var pa2 = class {
  ...
  async lookup(t2) {
    ...
    const e = await async function(t3, e2) {
      ...
      }, r = await n.fo("BatchGetDocuments", s, i, e2.length), o = new Map();
      r.forEach((t4) => {
...
var Ia2 = class {
  ...
  xc(t2) {
    if (t2.name === "FirebaseError") {
      const e = t2.code;
      return e === "aborted" || e === "failed-precondition" || e === "already-exists" || !ri(e);
    }
    return false;
  }
};
...
function Ra2(t2) {
  return t2.name === "FirebaseError" ? t2.code === B2.FAILED_PRECONDITION || t2.code === B2.UNIMPLEMENTED : !(typeof DOMException != "undefined" && t2 instanceof DOMException) || (t2.code === 22 || t2.code === 20 || t2.code === 11);
}
...
function Ma2(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await nu(t3, e2, true), i = new Dc2(e2, s.Wi), r = i.zu(s.documents), o = i.applyChanges(r, false);
...
function Fa(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new ga({
      next: (n3) => {
        e2.enqueueAndForget(() => pc2(t3, o)), n3.fromCache && s2.source === "server" ? i.reject(new L2(B2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new Ac2(n2, r, {
      includeMetadataChanges: true,
...
var Ya2 = class {
  constructor(t2) {
    ...
    if (this.credentials = t2.credentials, this.ignoreUndefinedProperties = !!t2.ignoreUndefinedProperties, this.cache = t2.localCache, t2.cacheSizeBytes === void 0)
...
var nh = class extends eh {
  ...
  get parent() {
    ...
    return t2.isEmpty() ? null : new th(this.firestore, null, new ct(t2));
  }
  withConverter(t2) {
...
function sh(t2, e, ...n) {
  ...
  }
  {
    ...
    return ja2(s), new nh(t2.firestore, null, s);
  }
}
function ih(t2, e) {
  ...
  return new eh(t2, null, function(t3) {
    return new Bn(rt.emptyPath(), t3);
  }(e));
}
function rh(t2, e, ...n) {
  if (t2 = getModularInstance(t2), arguments.length === 1 && (e = Z.A()), Ga("doc", "path", e), t2 instanceof Za) {
    const s = rt.fromString(e, ...n);
    return za2(s), new th(t2, null, new ct(s));
  }
  {
    if (!(t2 instanceof th || t2 instanceof nh))
      throw new L2(B2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
var ch = class {
  constructor() {
    ...
    const t2 = Pu();
    t2 && typeof t2.addEventListener == "function" && t2.addEventListener("visibilitychange", this.qc);
  }
  get isShuttingDown() {
    return this.Oc;
  }
  ...
  enterRestrictedMode(t2) {
    if (!this.Oc) {
      ...
      const e = Pu();
      e && typeof e.removeEventListener == "function" && e.removeEventListener("visibilitychange", this.qc);
    }
  }
  enqueue(t2) {
    if (this.Uc(), this.Oc)
...
var fh = class extends Za {
  constructor(t2, e, n, s) {
    super(t2, e, n, s), this.type = "firestore", this._queue = new ch(), this._persistenceKey = (s == null ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function mh(t2) {
  ...
  }(t2._databaseId, ((e = t2._app) === null || e === void 0 ? void 0 : e.options.appId) || "", t2._persistenceKey, i);
  t2._firestoreClient = new Ta2(t2._authCredentials, t2._appCheckCredentials, t2._queue, r), ((n = i.cache) === null || n === void 0 ? void 0 : n._offlineComponentProvider) && ((s = i.cache) === null || s === void 0 ? void 0 : s._onlineComponentProvider) && (t2._firestoreClient._uninitializedComponentsProvider = {
...
function gh(t2, e) {
  ...
  return ph(n, i, new da2(i, s.cacheSizeBytes, e == null ? void 0 : e.forceOwnership));
}
function yh(t2) {
  Ph(t2 = Ha(t2, fh));
  const e = _h(t2);
...
var $h = class {
  ...
  toMutation(t2, e) {
    return this.fieldMask !== null ? new Gs(t2, this.data, this.fieldMask, e, this.fieldTransforms) : new Ks(t2, this.data, e, this.fieldTransforms);
  }
};
var Mh = class {
  constructor(t2, e, n) {
...
var Bh = class {
  constructor(t2, e, n, s, i, r) {
    this.settings = t2, this.databaseId = e, this.serializer = n, this.ignoreUndefinedProperties = s, i === void 0 && this.Jc(), this.fieldTransforms = i || [], this.fieldMask = r || [];
  }
  get path() {
  ...
  Xc(t2) {
    var e;
    const n = (e = this.path) === null || e === void 0 ? void 0 : e.child(t2), s = this.Zc({
      path: n,
      ta: false
    });
    return s.ea(t2), s;
...
var Kh = class extends Nh {
  _toFieldTransform(t2) {
    if (t2.Yc !== 2)
      throw t2.Yc === 1 ? t2.ia(`${this._methodName}() can only appear at the top level of your update data`) : t2.ia(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var zh = class extends Nh {
  ...
  _toFieldTransform(t2) {
    const e = Gh(this, t2, true), n = this.ca.map((t3) => Zh(t3, e)), s = new vs(n);
...
var jh = class extends Nh {
  ...
  _toFieldTransform(t2) {
    const e = Gh(this, t2, true), n = this.ca.map((t3) => Zh(t3, e)), s = new Ps(n);
    return new xs(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
function Zh(t2, e) {
  if (tl(t2 = getModularInstance(t2)))
...
function tl(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof nt || t2 instanceof kh || t2 instanceof Dh || t2 instanceof th || t2 instanceof Nh);
}
function el(t2, e, n) {
  if (!tl(n) || !function(t3) {
    ...
    const s = Wa2(n);
    throw s === "an object" ? e.ia(t2 + " a custom object") : e.ia(t2 + " " + s);
  }
}
function nl(t2, e, n) {
  ...
  if (typeof e == "string")
    return il(t2, e);
  throw rl("Field path arguments must be of type string or ", t2, false, void 0, n);
}
var sl = new RegExp("[~\\*/\\[\\]]");
function il(t2, e, n) {
  if (e.search(sl) >= 0)
    throw rl(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t2, false, void 0, n);
  try {
    return new Ch(...e.split("."))._internalPath;
  } catch (s) {
    throw rl(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t2, false, void 0, n);
  }
}
...
var ul = class {
  ...
  data() {
    if (this._document) {
      if (this._converter) {
        const t2 = new cl(this._firestore, this._userDataWriter, this._key, this._document, null);
...
function al(t2, e) {
  return typeof e == "string" ? il(t2, e) : e instanceof Ch ? e._internalPath : e._delegate._internalPath;
}
function hl(t2) {
  ...
  _parse(t2) {
    const e = qh(t2.firestore), n = function(t3, e2, n2, s, i, r, o) {
      ...
      if (i.isKeyField()) {
        ...
        r !== "in" && r !== "not-in" && r !== "array-contains-any" || xl(o, r), u = Yh(n2, e2, o, r === "in" || r === "not-in");
...
var ml = class extends ll {
  ...
  _parse(t2) {
    ...
    return e.length === 1 ? e[0] : wn.create(e, this._getOperator());
  }
  _apply(t2) {
    const e = this._parse(t2);
...
function vl(...t2) {
  return Rl._create("startAt", t2, true);
}
function bl(...t2) {
  return Rl._create("startAfter", t2, false);
}
var Pl = class extends fl {
  constructor(t2, e, n) {
    super(), this.type = t2, this._docOrFields = e, this._inclusive = n;
...
function Vl(...t2) {
  return Pl._create("endBefore", t2, false);
}
function Sl(...t2) {
  return Pl._create("endAt", t2, true);
}
...
function Ul(t2, e) {
  var n, s;
  return t2 instanceof Vh && e instanceof Vh && t2._aggregateType === e._aggregateType && ((n = t2._internalFieldPath) === null || n === void 0 ? void 0 : n.canonicalString()) === ((s = e._internalFieldPath) === null || s === void 0 ? void 0 : s.canonicalString());
}
function Kl(t2, e) {
...
var Ql = class extends ul {
  ...
  data(t2 = {}) {
    if (this._document) {
      if (this._converter) {
        const e = new zl(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, null);
...
function Hl(t2, e) {
  return t2 instanceof Ql && e instanceof Ql ? t2._firestore === e._firestore && t2._key.isEqual(e._key) && (t2._document === null ? e._document === null : t2._document.isEqual(e._document)) && t2._converter === e._converter : t2 instanceof jl && e instanceof jl && (t2._firestore === e._firestore && uh(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._snapshot.isEqual(e._snapshot));
}
function Jl(t2) {
  t2 = Ha(t2, th);
...
function Zl(t2) {
  ...
  return Oa2(n, t2._key).then((n2) => new Ql(e, s, t2._key, n2, new Gl(n2 !== null && n2.hasLocalMutations, true), t2.converter));
}
function Xl(t2) {
  t2 = Ha(t2, th);
  const e = Ha(t2.firestore, fh);
...
function sf(t2, e, n) {
  ...
  return hf(s, [Uh(qh(s), "setDoc", t2._key, i, t2.converter !== null, n).toMutation(t2._key, Os.none())]);
}
function rf(t2, e, n, ...s) {
  t2 = Ha(t2, th);
  const i = Ha(t2.firestore, fh), r = qh(i);
  let o;
  o = typeof (e = getModularInstance(e)) == "string" || e instanceof Ch ? Jh(r, "updateDoc", t2._key, e, n, s) : Hh(r, "updateDoc", t2._key, e);
...
function uf(t2, e) {
  ...
  return hf(n, [Uh(qh(t2.firestore), "addDoc", s._key, i, t2.converter !== null, {}).toMutation(s._key, Os.exists(false))]).then(() => s);
}
function cf(t2, ...e) {
  var n, s, i;
  ...
  typeof e[o] != "object" || ah(e[o]) || (r = e[o], o++);
  const u = {
...
var _f = class {
  constructor(t2) {
    let e;
    this.kind = "persistent", (t2 == null ? void 0 : t2.tabManager) ? (t2.tabManager._initialize(t2), e = t2.tabManager) : (e = If(void 0), e._initialize(t2)), this._onlineComponentProvider = e._onlineComponentProvider, this._offlineComponentProvider = e._offlineComponentProvider;
  }
  toJSON() {
    return {
      kind: this.kind
...
var yf = class {
  ...
  _initialize(t2) {
    this._onlineComponentProvider = new _a(), this._offlineComponentProvider = new da2(this._onlineComponentProvider, t2 == null ? void 0 : t2.cacheSizeBytes, this.forceOwnership);
  }
};
var pf = class {
  constructor() {
  ...
  _initialize(t2) {
    this._onlineComponentProvider = new _a(), this._offlineComponentProvider = new wa2(this._onlineComponentProvider, t2 == null ? void 0 : t2.cacheSizeBytes);
  }
};
function If(t2) {
  return new yf(t2 == null ? void 0 : t2.forceOwnership);
}
function Tf() {
  return new pf();
}
...
var Af = class {
  ...
  set(t2, e, n) {
    ...
    const s = Rf(t2, this._firestore), i = Ml(s.converter, e, n), r = Uh(this._dataReader, "WriteBatch.set", s._key, i, s.converter !== null, n);
  ...
  update(t2, e, n, ...s) {
    ...
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof Ch ? Jh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : Hh(this._dataReader, "WriteBatch.update", i._key, e), this._mutations.push(r.toMutation(i._key, Os.exists(true))), this;
  }
  delete(t2) {
    this._verifyNotCommitted();
...
var vf = class extends class {
  ...
  set(t2, e, n) {
    const s = Rf(t2, this._firestore), i = Ml(s.converter, e, n), r = Uh(this._dataReader, "Transaction.set", s._key, i, s.converter !== null, n);
    return this._transaction.set(s._key, r), this;
  }
  update(t2, e, n, ...s) {
    const i = Rf(t2, this._firestore);
    let r;
    return r = typeof (e = getModularInstance(e)) == "string" || e instanceof Ch ? Jh(this._dataReader, "Transaction.update", i._key, e, n, s) : Hh(this._dataReader, "Transaction.update", i._key, e), this._transaction.update(i._key, r), this;
  }
  delete(t2) {
    const e = Rf(t2, this._firestore);
  ...
  get(t2) {
    ...
    return super.get(t2).then((t3) => new Ql(this._firestore, n, e._key, t3._document, new Gl(false, false), e.converter));
  }
};
function bf(t2, e, n) {
  t2 = Ha(t2, fh);
...
function Nf(t2, e) {
  ...
  if (!s._uninitializedComponentsProvider || ((n = s._uninitializedComponentsProvider) === null || n === void 0 ? void 0 : n._offlineKind) === "memory")
  ...
  const i = function(t3) {
    const e2 = typeof t3 == "string" ? function(t4) {
      try {
        ...
        throw new L2(B2.INVALID_ARGUMENT, "Failed to parse JSON: " + (t5 == null ? void 0 : t5.message));
      }
    }(t3) : t3, n2 = [];
